...
/**
 * This class defines the abstract data type sample.Employee which encapsulates the
...
public class Employee {
    ...
    /**
     * A two parameter sample.Employee constructor that initializes an sample.Employee object when
     * it is created.
     *
     ...
     *
     * @return profile attribute for an sample.Employee Object.
     */
    ...
    /**
     * Empty method written in sample.Employee in order to be overridden by subclasses
     */
